...
public class KorisnikController {
    ...
    @Autowired
    private TicketToTicketDto toTicktDto;
   ...
   // @PreAuthorize("hasRole('ROLE_KORISNIK')")
    ...
    public ResponseEntity<List<TicketDTO>> findByFilmId(@PathVariable @Positive(message = "Id must be positive.")  Long id){
        List<Ticket> tickets = ticketService.findByUserId(id);

        return new ResponseEntity<>(toTicktDto.convert(tickets), HttpStatus.OK);
    }
}
