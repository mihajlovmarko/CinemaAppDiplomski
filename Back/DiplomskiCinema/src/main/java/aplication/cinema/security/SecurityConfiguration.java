...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.cors().and().csrf().disable().sessionManagement()
				...
				.antMatchers(HttpMethod.POST, "/api/korisnici/auth").permitAll()
				...
				.antMatchers(HttpMethod.DELETE, "/api/movies/{id}").permitAll()
				.antMatchers(HttpMethod.PUT, "/api/movies/{id}").permitAll()
				.antMatchers(HttpMethod.GET, "/api/movies/{id}").permitAll()
				...
				.antMatchers(HttpMethod.POST, "/api/ticket").permitAll()
				.antMatchers(HttpMethod.GET, "/api/ticket/{id}").permitAll()
			  
				.antMatchers(HttpMethod.GET, "/api/movies/{id}/projection").permitAll()
	...
	CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedHeaders(Arrays.asList("Content-Type", "content-type", "x-requested-with",
				...
				"Accept", "X-Requested-With", "Access-Control-Request-Method", "Access-Control-Request-Headers", "Authorization"));
